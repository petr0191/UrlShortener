...
<body>
	...
	<div class="container">
		<p id="copyMessage" style="display: none; color: green;"></p>
	</div>
        ...
        <tbody>
            <c:forEach var="urlMap" items="${shortenedUrls}">
                <tr>
                    ...
                    <td>${urlMap.count}</td>
                    <td>
			            <button onclick="copyToClipboard('${urlMap.slug}');">Copy Slug</button>
			        </td>
                </tr>
            </c:forEach>
        </tbody>
    ...
    <div class="container">
     ...
     <script>
		     function copyToClipboard(text) {
		    	 var shortenedUrl = baseUrl + "/r/" + text;
		         ...
		         copyMessage.innerText = 'Shortened URL copied to clipboard!';
